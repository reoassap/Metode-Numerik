...
# Menyimpan pasangan (R, f(R)) yang valid dalam satu langkah untuk mencegah pemanggilan ganda
valid_R_f_values = [(R, f(R)) for R in R_values if f(R) is not None]
R_values, f_values = zip(*valid_R_f_values)
